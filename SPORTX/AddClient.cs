...
{ 
    ...
    public partial class AddClient : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string Tarif = textBox4.Text;
            string Time = textBox5.Text;
            string trainer = textBox6.Text;
            string query = "INSERT INTO Клиенты ([ID],[ФИО],[Телефон],[Абонимент],[Срок действия],[Тренер]) VALUES (" + ID + ", '" + Name + "', '" + Phone + "', '" + Tarif + "','" + Time + "','" + trainer + "')";
